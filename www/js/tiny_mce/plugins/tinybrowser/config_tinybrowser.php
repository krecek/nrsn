 ...
 */
session_start();
$adresa = $_SESSION['adresa_prilohy'];
...
$tinybrowser['thumb_prefix']='_tn_';
$tinybrowser['allow_to_create_folders']=false; //smi vytvaret adresare (i napr. pro nahledy, vytvori adresar _thumbs)
...
$tinybrowser['path']['image'] = $adresa; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $adresa; // Media files location
$tinybrowser['path']['file'] = $adresa; // Other files location
...
$_SESSION[$tinybrowser['sessioncheck']]=1;
?>
